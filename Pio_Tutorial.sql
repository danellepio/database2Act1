...
-- Started on 2019-12-17 16:43:03
...
--
-- TOC entry 197 (class 1259 OID 4948314)
-- Name: pio_tutorial; Type: TABLE; Schema: public; Owner: yhpifogabxdirh
--

CREATE TABLE public.pio_tutorial (
...
ALTER TABLE public.pio_tutorial OWNER TO yhpifogabxdirh;

--
-- TOC entry 196 (class 1259 OID 4947265)
-- Name: temp; Type: TABLE; Schema: public; Owner: yhpifogabxdirh
--
...
ALTER TABLE public.temp OWNER TO yhpifogabxdirh;

--
-- TOC entry 3825 (class 0 OID 4948314)
-- Dependencies: 197
-- Data for Name: pio_tutorial; Type: TABLE DATA; Schema: public; Owner: yhpifogabxdirh
--

COPY public.pio_tutorial (staffno, tutorname, tuteeno, tuteename, appdate, apptime, tutorialno) FROM stdin;
...
S1023	Jeff Bezos	T107	CANETE, NEIL FRED C.	15-Jan-2020	16.00	T12
S1111	Tim Cook	T111	BAYACAG, ELDON REY C.	15-Jan-2020	16.30	T52
S2939	Sunday Pichai	T101	DINERO, VINCENT B.	9-Jan-2020	10.00	T99
...
S1521	Susan Wojcickl	T102	PEREZ, JOHN PAUL S.	5-Jan-2020	9.00	T12
...
--
-- TOC entry 3824 (class 0 OID 4947265)
-- Dependencies: 196
-- Data for Name: temp; Type: TABLE DATA; Schema: public; Owner: yhpifogabxdirh
--
...
-- Dependencies: 3
-- Name: SCHEMA public; Type: ACL; Schema: -; Owner: yhpifogabxdirh
--

REVOKE ALL ON SCHEMA public FROM postgres;
REVOKE ALL ON SCHEMA public FROM PUBLIC;
GRANT ALL ON SCHEMA public TO yhpifogabxdirh;
...
GRANT ALL ON LANGUAGE plpgsql TO yhpifogabxdirh;


-- Completed on 2019-12-17 16:43:25
